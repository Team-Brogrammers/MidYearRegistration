...
public class ValidateEmail {
    ...
    public ValidateEmail(String email){
	 ...
	 public  boolean validate( String email) {
	           ...
	           return  isAddressValid( testData[0]);

	      }
    public int hear( BufferedReader in ) throws IOException {
      String line = null;
      int res = 0;
    ...
    public void say( BufferedWriter wr, String text )
       throws IOException {
      wr.write( text + "\r\n" );
      wr.flush();
      return;
      }
    public ArrayList getMX( String hostName )
